class ListadoProductos {
    constructor(marca, modelo, talles, color, categoria, precio) {
        this.marca = marca;
        this.modelo = modelo;
        this.talle = talles;
        // this.stock = stock;
...
class CarroDeCompras {
    constructor(marca, modelo, talles, color, cantidad, codProducto, imagen, precio, posicion) {
        this.marca = marca;
        this.modelo = modelo;
        this.talle = talles;
        this.color = color;
...
listadoProductos.push(new ListadoProductos("Adidas", "Ultra Boost 21", [36, 37], "Blanco", "Mujer", 34.999));
listadoProductos.push(new ListadoProductos("Adidas", "Boston 10", [38, 39], "Azul", "Hombre", 42.195));
listadoProductos.push(new ListadoProductos("Nike", "Pegasus 38", [40, 41, 42], "Verde", "Hombre", 26.499));
listadoProductos.push(new ListadoProductos("Puma", "Deviate Nitro", [43, 44, 45], "Naranja", "Hombre", 28.599));
listadoProductos.push(new ListadoProductos("Saucony", "Endorphin", [37, 38, 39], "Azul", "Mujer", 22.199));
listadoProductos.push(new ListadoProductos("Saucony", "Ride 14", [40, 42, 43], "Verde", "Hombre", 19.899));
listadoProductos.push(new ListadoProductos("Saucony", "Speed", [39, 42, 43], "Blancas", "Hombre", 31.199));
listadoProductos.push(new ListadoProductos("New Balance", "Fresh Foam", [40, 42, 43], "Celeste", "Hombre", 29.480));
listadoProductos.push(new ListadoProductos("Nike", "Tempo Next%", [40, 42, 43], "Blancas", "Hombre", 52.140));
listadoProductos.push(new ListadoProductos("Adidas", "SL 20", [35, 36, 38], "Rosa", "Hombre", 21.420));
listadoProductos.push(new ListadoProductos("Nike", "Joyride", [39, 40, 41], "Blancas", "Mujer", 33.140));
listadoProductos.push(new ListadoProductos("Nike", "React Infinity", [40, 42, 43], "Azul", "Hombre", 32.180));
listadoProductos.push(new ListadoProductos("Asics", "Nimbus 22", [41, 43, 44], "Gris", "Hombre", 27.399));
listadoProductos.push(new ListadoProductos("Asics", "Tri Noosa", [40, 42, 43], "Verde", "Hombre", 21.410));
    ...
    listadoProductos.forEach((listadoProductos) => {
        ...
        btnAgregar.addEventListener("click", () => {
            ...
            if (talleCompra == "Elegí tu talle") {
                ...
                const { marca, modelo, color, codProducto, precio } = listadoProductos
                let cantidad = 1;
                let codCompra = codProducto + talleCompra
                let imagen = marca.charAt(0) + modelo.charAt(0) + color.charAt(0);
                let posicion = carroDeCompras.length;

                carroDeCompras.push(new CarroDeCompras(marca, modelo, parseInt(talleCompra), color, cantidad, codCompra, imagen, precio, posicion));
